# 🔒 Security Best Practices for PlacementIQ
...
## 📧 What to Do If GitHub Sends a Secret Alert
...
1. ✅ **Always use `.env` files** for secrets (never hardcode)
...
7. ✅ **Use platform environment variables** in production
8. ✅ **Enable GitHub secret scanning**
9. ✅ **Limit CORS origins** in production (no `*`)
10. ✅ **Use HTTPS** for all production URLs
